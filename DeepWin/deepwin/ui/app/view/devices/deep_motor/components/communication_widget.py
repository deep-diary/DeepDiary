...
class CommunicationWidget(QWidget):
    ...
    def __init__(self, title: str = "通信监控", log_manager: LogManager = None, 
        ...
        self.can_data = []     # CAN数据
        self.max_display_items = 1000  # 最大显示条目数
    ...
    def _create_data_display_widget(self, title: str, data_type: str) -> QWidget:
        ...
        scroll_area.setMinimumHeight(300)  # 设置最小高度为600px
        scroll_area.setMaximumHeight(500)  # 设置最大高度为1000px
    ...
    def add_communication_data(self, direction: str, protocol: str, data: bytes, 
        ...
        if protocol == "serial":
            ...
            if self.logger:
                ...
                # 添加详细调试信息
                self.logger.info(f"CAN数据详情: timestamp={timestamp}, can_id={can_id}, hex_data={hex_data}")
