...
DeepCard-ESP32S3 是 睿思铂尔 推出的基于 ESP32-S3 的物联网可编程控制器，采用了 ES8311 单声道音频解码器、MEMS 麦克风和 NS4150B 功率放大器的集成方案。
...
- `Xiaozhi Assistant` → `Board Type` → 选择 `deepcard_esp32s3`
...
将 DeepCard-ESP32S3 连接到电脑，按住侧面 RESET 按键，直到 RESET 按键下方绿灯闪烁。
